...
### Overview
The OrderBook is a C++ implementation of a financial order book, focusing on the GOOGL v USD market. It uses the FIFO (First In, First Out) order matching algorithm.
